local M = {}
local Client = require("opencode.editor.client")
local handshake = require("opencode.editor.handshake")
local tcp_server = require("opencode.editor.tcp")
...
function M.start(port, auth_token)
  ...
  local server, err = tcp_server.create_server("127.0.0.1", port, function(tcp_client)
    ...
    tcp_client:read_start(function(err, data)
